package com.bmagario.saga.kafka.producer.service.impl;

import com.bmagario.saga.kafka.producer.exception.KafkaProducerException;
    ...
    public void send(String topicName, K key, V message,
        ...
        try {
            ListenableFuture<SendResult<K, V>> kafkaResultFuture =
                    (ListenableFuture<SendResult<K, V>>) kafkaTemplate.send(topicName, key,
                            message);
